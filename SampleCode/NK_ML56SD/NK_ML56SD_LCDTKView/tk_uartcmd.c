...
extern    volatile uint8_t xdata gbIsFineTuneDone = 0;
extern    volatile uint8_t xdata gFineTuneDoneTimeOut = 0;
#endif
...
int8_t TK_CmdType1(uint8_t *pu8RXBuf)
{
    ...
    psTkInfo = TK_GetTKInfoPtr();////Joey
    //printf("psKeyInfo = [%x][%x][%x][%x]\n" ,psKeyInfo->ccb,psKeyInfo->refcb,psKeyInfo->level,psKeyInfo->threshold);
    ...
    *((uint8_t *)&u32Data + 3) = pu8RXBuf[1];
    ...
    switch (*pu8RXBuf)
    {
        ...
        case E_CMD_TYPE1_SPECIFY_REF_SHIELD_NO:
            ...
            //  printf("4 = [%x][%x][%x][%x]\n" ,(uint16_t)pu8RXBuf[1],(uint16_t)pu8RXBuf[2],(uint16_t)pu8RXBuf[3],(uint16_t)pu8RXBuf[4]);
            break;
...
#endif
            //      printf("14 = [%bx][%bx][%bx][%bx]\n" ,pu8RXBuf[1],pu8RXBuf[2],pu8RXBuf[3],pu8RXBuf[4]);
#endif
            break;
...
int8_t TK_CmdType2(uint8_t *pu8RXBuf)
{
    ...
    switch (*pu8RXBuf)
    {
        case E_CMD_TYPE2_READ_CHANNEL_MSK:
            ...
            //  printf("CHANNEL = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
#endif
            break;
        ...
        case E_CMD_TYPE2_READ_SLIDER_MSK:
            ...
            //      printf("SLIDER = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
#endif
            break;
        ...
        case E_CMD_TYPE2_READ_WHEEL_MSK:
            ...
            //  printf("WHEEL = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
#endif
            gu8TXBuf[4] = 'A';
            break;
        ...
        case E_CMD_TYPE2_READ_REF_SHIELD_NO:
            ...
            //  printf("REF_SHIELD = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
            break;
        ...
        case E_CMD_TYPE2_READ_FEATURE:
            ...
            //gu8TXBuf[3] = 0x0;
            //      printf("FEATURE = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
            break;
        ...
        case E_CMD_TYPE2_READ_SENSE:
            ...
            //gu8TXBuf[3] = 0x0;
            //      printf("SENSE = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
            break;
        ...
        case E_CMD_TYPE2_READ_RESET_VOL:
            ...
            //gu8TXBuf[3] = 0x0;
            //      printf("VOL = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
            break;
        ...
        case E_CMD_TYPE2_READ_STORE_ADDR:
            ...
            //  printf("ADDR = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
            break;
        ...
        case E_CMD_TYPE2_READ_NEIGHBORING:
            ...
            //  printf("NEIG[%bx][%bx][%bx]\n" ,gu8TXBuf[0],gu8TXBuf[1],pu8RXBuf[1]);
#endif
            break;
        ...
        case E_CMD_TYPE2_GET_CALIBRATION1:
            ...
            //      printf("GET_CALIBRATION1 = [0x%bx][0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3],chan);
            break;
        ...
        case E_CMD_TYPE2_GET_CALIBRATION2:
            ...
            //printf("GET_CALIBRATION2 = [0x%bx][0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3],chan);
            break;
        ...
        case E_CMD_TYPE2_EXPORT_CALIBRATION:
            ...
            //printf("EXPORT_CALIBRATION = [0x%bx][0x%bx][0x%bx][0x%bx]\n", gu8TXBuf[0], gu8TXBuf[1], gu8TXBuf[2], gu8TXBuf[3]);
            break;
...
int8_t TK_GetPacket(uint32_t *pu32ChanelMsk)
{
    ...
    *pu32ChanelMsk = (psTkInfo->u32EnChanMsk) | ((psTkInfo->u32EnSliderMsk | psTkInfo->u32EnWheelMsk)\
    ...
    //GP1 = [0x81]**[1][0][0][7]
    printf("GP1 = [0x%lx]", *pu32ChanelMsk);
    printf("**[%lx][%lx][%lx][%bx]\n", psTkInfo->u32EnChanMsk, psTkInfo->u32EnSliderMsk, psTkInfo->u32EnWheelMsk, psTkInfo->u8RefChan);
