...
#define I2C_CLOCK               14           /* I2C clock = 24MHz /4*(14+1) = 400k */
...
{
    MFP_P41_I2C0_SCL;
    P41_OPENDRAIN_MODE;     /*I2C_SCL*/ 
    MFP_P40_I2C0_SDA;
    P40_OPENDRAIN_MODE;     /*I2C_SDA*/
...
{
    SFRS=0;
    while(I2C0CON&SET_BIT3)     /* while SI=1;  measn noise cause SI clear error. Keep clear try clear SI command*/
    {
        if (I2C0STAT == 0x00)
        {
            I2C_Reset_Flag = 1;
