...
#define APROM_SIZE           60*1024

extern  xdata volatile uint8_t rxbuf[64];
extern xdata volatile uint8_t rxcgbuf[56];
extern  xdata volatile uint8_t txbuf[64];
...
extern  bit volatile bSPIDataReady;
extern bit volatile bSPISendFlag;
...
void Package_checksum0(void);
void Package_checksum1(void);
